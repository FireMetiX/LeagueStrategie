<?php 
    ...
    if (isset($_POST["submit"])) {
        ...
        if($error != true){ // Wenn keine Fehler gefunden worden sind
            ...
            if ($_POST['submit'] == "Erstellen") { // Prüft, ob der User den Guide Erstellen will
                // echo "Guide wird erstellt";
                $userID = $_SESSION['userID'];
                $username = $_SESSION['username'];
                $instanz->insertGuide($userID, $username, $titleOfGuide, $championSelection, $role, $primaryRune, $primaryRune1, 
                ...
                $abilityMaxing2, $abilityMaxing3short, $abilityMaxing3, $abilityMaxing4short, $abilityMaxing4, $editor1);


                if ( $noItemBuild != true ) { // Wenn ein Itembuild vorhanden ist, soll es die insertItemBuild Methode aufrufen

                    $latestGuideID = $instanz->getLatestGuideID(); // Holt sich die neuste Guide ID für das einfügen des Item Builds aus
                    $instanz->insertItemBuild($latestGuideID, $itemSet1, $Set1item1, $Set1item2, $Set1item3, $Set1item4, $Set1item5, $Set1item6, $Set1item7, $Set1item8, $Set1item9, $Set1item10, 
            ...
            } else { // Wenn nicht, wird der Guide Editiert
                // echo "Guide wird Bearbeitet";
                $userID = $_SESSION['userID'];
                $guideID = $_POST['guideID'];
                $instanz->editGuide($guideID, $titleOfGuide, $championSelection, $role, $primaryRune, $primaryRune1,
                $primaryRune2, $primaryRune3, $primaryRune4, $secondaryRune, $secondaryRune1, $secondaryRune2, $runeStatMod1,
                $runeStatMod2, $runeStatMod3, $summonerSpell1, $summonerSpell2, $abilityMaxing1short, $abilityMaxing1, $abilityMaxing2short,
                $abilityMaxing2, $abilityMaxing3short, $abilityMaxing3, $abilityMaxing4short, $abilityMaxing4, $editor1);
                ...
                if ( $noItemBuild != true ) { // Wenn ein Itembuild vorhanden ist, soll es die insertItemBuild Methode aufrufen
                    ...
                    $checkIfItembuild = $instanz->checkIfItemBuild($guideID); // Prüft, ob ein Item Build für den editierten Guide schon existiert

                    if ($checkIfItembuild == true) { // Wenn ein ItemBuild verfügbar

                        $instanz->editItemBuild($guideID, $itemSet1, $Set1item1, $Set1item2, $Set1item3, $Set1item4, $Set1item5, $Set1item6, $Set1item7, $Set1item8, $Set1item9, $Set1item10, 
                        $itemSet2, $Set2item1, $Set2item2, $Set2item3, $Set2item4, $Set2item5, $Set2item6, $Set2item7, $Set2item8, $Set2item9, $Set2item10,
                        $itemSet3, $Set3item1, $Set3item2, $Set3item3, $Set3item4, $Set3item5, $Set3item6, $Set3item7, $Set3item8, $Set3item9, $Set3item10,
                        $itemSet4, $Set4item1, $Set4item2, $Set4item3, $Set4item4, $Set4item5, $Set4item6, $Set4item7, $Set4item8, $Set4item9, $Set4item10,
                        $itemSet5, $Set5item1, $Set5item2, $Set5item3, $Set5item4, $Set5item5, $Set5item6, $Set5item7, $Set5item8, $Set5item9, $Set5item10,
                        ...
                        $instanz->insertItemBuild($guideID, $itemSet1, $Set1item1, $Set1item2, $Set1item3, $Set1item4, $Set1item5, $Set1item6, $Set1item7, $Set1item8, $Set1item9, $Set1item10, 
                        $itemSet2, $Set2item1, $Set2item2, $Set2item3, $Set2item4, $Set2item5, $Set2item6, $Set2item7, $Set2item8, $Set2item9, $Set2item10,
                        $itemSet3, $Set3item1, $Set3item2, $Set3item3, $Set3item4, $Set3item5, $Set3item6, $Set3item7, $Set3item8, $Set3item9, $Set3item10,
                        $itemSet4, $Set4item1, $Set4item2, $Set4item3, $Set4item4, $Set4item5, $Set4item6, $Set4item7, $Set4item8, $Set4item9, $Set4item10,
                        $itemSet5, $Set5item1, $Set5item2, $Set5item3, $Set5item4, $Set5item5, $Set5item6, $Set5item7, $Set5item8, $Set5item9, $Set5item10,
