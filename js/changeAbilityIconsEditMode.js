...
const championSelect2 = document.querySelector("#championSelect");
...
function changeAbilityIcons() {
    const chosenChampion = championSelect2.value;
    ...
    fetch(`https://ddragon.leagueoflegends.com/cdn/10.24.1/data/en_US/champion/${chosenChampion}.json`)
